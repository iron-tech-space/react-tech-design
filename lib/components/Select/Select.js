...
var Select = function Select(props) {
	...
	var _onChangeSelectAll = function _onChangeSelectAll() {
		console.log("_onChangeSelectAll", _isSelectAll, value);
		if (props.mode === 'multiple') {
			if (_isSelectAll) {
				...
				if (Array.isArray(value)) {
					onChange([].concat(_toConsumableArray(new Set([].concat(_toConsumableArray(value), _toConsumableArray(_options.map(function (item) {
						return item.value;
					})))))));
