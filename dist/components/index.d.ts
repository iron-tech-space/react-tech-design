...
export declare const Title: FunctionComponent<TitleProps & StoreProps>;
export declare const Text: FunctionComponent<TextProps & StoreProps>;
export declare const DateText: FunctionComponent<DatePickerProps & StoreProps>;
export declare const Divider: FunctionComponent<DividerProps & StoreProps>;
...
export declare const Checkbox: FunctionComponent<CheckboxProps & StoreProps>;
