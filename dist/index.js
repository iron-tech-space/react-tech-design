...
var inheritsLoose__default = /*#__PURE__*/_interopDefaultLegacy(inheritsLoose);
var assertThisInitialized__default = /*#__PURE__*/_interopDefaultLegacy(assertThisInitialized);
var objectWithoutPropertiesLoose__default = /*#__PURE__*/_interopDefaultLegacy(objectWithoutPropertiesLoose);
...
var mapDispatchToProps$4 = function mapDispatchToProps(dispatch) {
	return redux.bindActionCreators({ setDateStore: setDataStore }, dispatch);
};
...
var withItem = function withItem(Component) {
    return function (props) {
        ...
        return render(_Form__default['default'].Item)(__assign(__assign({}, itemProps), { noStyle: !(itemProps && itemProps.label), children: render(Component)(rest) }));
    };
};
...
var _extends = _interopDefault(_extends__default['default']);
var _inheritsLoose = _interopDefault(inheritsLoose__default['default']);
var _assertThisInitialized = _interopDefault(assertThisInitialized__default['default']);
var memoizeOne$1 = _interopDefault(memoizeOne);

var _objectWithoutPropertiesLoose = _interopDefault(objectWithoutPropertiesLoose__default['default']);
...
function createGridComponent(_ref2) {
  ...
  function (_PureComponent) {
    ...
    _proto.render = function render() {
      ...
      if (columnCount > 0 && rowCount) {
        for (var _rowIndex = rowStartIndex; _rowIndex <= rowStopIndex; _rowIndex++) {
          for (var _columnIndex = columnStartIndex; _columnIndex <= columnStopIndex; _columnIndex++) {
            items.push(React__default['default'].createElement(children, {
      ...
      return React__default['default'].createElement(outerElementType || outerTagName || 'div', {
        className: className,
      ...
      }, React__default['default'].createElement(innerElementType || innerTagName || 'div', {
        children: items,
        ref: innerRef,
        style: {
    ...
    return Grid;
  }(React__default['default'].PureComponent), _class.defaultProps = {
    direction: 'ltr',
    itemData: undefined,
